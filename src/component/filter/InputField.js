...
const InputField= ({label}) => {
	...
	useEffect(() => {
		if(label=='from' && searchState?.departureAirport) setData(searchState?.departureAirport);
		if(label=='to' && searchState?.arrivalAirport) setData(searchState?.arrivalAirport);
